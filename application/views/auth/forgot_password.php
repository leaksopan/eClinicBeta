...
<body>
    <div class="container">
        <div class="login-container">
            ...
            <p class="text-center mb-4">Masukkan alamat email Anda untuk menerima instruksi reset password.</p>
            ...
            <?= form_open('auth/forgot_password', ['class' => 'login-form']) ?>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email" placeholder="Masukkan email" value="<?= set_value('email') ?>" autofocus required>
                    </div>
                ...
                <div class="back-to-login">
                    <a href="<?= site_url('auth/login') ?>"><span class="icon">←</span> Kembali ke Login</a>
                </div>
            <?= form_close() ?>
